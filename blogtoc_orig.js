...
// this function creates a three-column table and adds it to the screen
   var numDisplayed = 0;
   var tocTable = '';
   var tocHead1 = 'ÇáÚäæÇä';
   var tocTool1 = 'Click to sort by title';
   var tocHead2 = 'ÇáÊÇÑíÎ';
   ...
   if (numDisplayed == postTitle.length) {
      var tocNote = '<span class="toc-note">ÚÑÖ ßá ÇáãæÖæÚÇÊ ' + postTitle.length + ' posts<br/></span>'; }
   else {
      var tocNote = '<span class="toc-note">ÚÑÖ ' + numDisplayed + ' posts labeled \'';
